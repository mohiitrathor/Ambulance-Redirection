...
# 4 = Critical
#
# These are NOT hard-coded clinical rules.
#
# They simply create a synthetic population where different
# emergency types have different severity distributions.
# ============================================================
...
# Base probability distributions for each condition.
#
# Order:
...
# IMPORTANT:
#
# This does NOT generate Severity.
#
# Severity was generated earlier.
#
# This score is only useful for analysis.
# ============================================================
...
print("patient_incidents.csv")
print("ambulances.csv")
print("hospitals.csv")
print("dispatch_scenarios.csv")